        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <select
              ...
              id="course-subject"
              class="mt-1 block w-full rounded-md border-gray-300 py-2 shadow-sm focus:border-red-500 focus:ring-red-500"
            >
          ...
          <div>
            ...
            <div class="relative mt-1 rounded-md shadow-sm">
              <input
                ...
                type="text"
                id="course-search"
                class="block w-full rounded-md border-gray-300 py-2 pr-10 focus:border-red-500 focus:ring-red-500"
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <button
              class="relative inline-flex items-center bg-red-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
            >
              1
            </button>
            <button
...
const courses = [
  {
    ...
    universityLogo: 'https://via.placeholder.com/100?text=UM',
    description:
  ...
  },
  {
    ...
    universityLogo: 'https://via.placeholder.com/100?text=HBS',
    description:
  ...
  },
  {
    ...
    country: 'Canada',
    universityLogo: 'https://via.placeholder.com/100?text=UT',
    description:
  ...
  },
  {
    ...
    country: 'Australia',
    universityLogo: 'https://via.placeholder.com/100?text=US',
    description:
  ...
  },
  {
    ...
    country: 'United Kingdom',
    universityLogo: 'https://via.placeholder.com/100?text=LSE',
    description:
  ...
  },
  {
    ...
    country: 'United States',
    universityLogo: 'https://via.placeholder.com/100?text=PSD',
    description:
  ...
  },
  {
    ...
    country: 'Germany',
    universityLogo: 'https://via.placeholder.com/100?text=TUM',
    description:
  ...
  },
  {
    ...
    country: 'New Zealand',
    universityLogo: 'https://via.placeholder.com/100?text=UA',
    description:
